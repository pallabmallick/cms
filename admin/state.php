...
$_SESSION['msg']="Plaza added Successfully !!";
...
<label class="control-label" for="basicinput"> Plaza Name</label>
<div class="controls">
<input type="text" placeholder="Enter Plaza Name"  name="state" class="span8 tip" required>
</div>
</div>
